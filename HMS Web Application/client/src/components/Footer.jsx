  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        <Grid container spacing={20} justifyContent="space-between" alignItems="flex-start">
          ...
          {/* Social Media Icons */}
          <Grid item xs={12} md={4}>
            <Typography variant="h6" gutterBottom color="text.primary" sx={{ textAlign: { xs: 'center', md: 'right' } }}>
              Follow Us
            </Typography>
