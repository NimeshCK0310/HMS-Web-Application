            ...
            <form onSubmit={Update}>
                ...
                <div className="form-grid">
                    ...
                    <div>
                        ...
                        <input type="date" placeholder="Enter Date of Birth" value={dob} onChange={(e) => setDob(e.target.value)} /><br />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Enter Doctor Name" value={doctor} onChange={(e) => setDoctor(e.target.value)} /><br />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" placeholder="Enter Date" value={date} onChange={(e) => setDate(e.target.value)} /><br />
                    </div>
                    <div>
                        <label htmlFor="time">Time</label>
                        <input type="time" placeholder="Enter Time" value={time} onChange={(e) => setTime(e.target.value)} /><br />
                    </div>
                </div>
