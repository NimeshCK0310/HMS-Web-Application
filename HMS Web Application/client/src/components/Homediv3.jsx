        ...
        <Grid item xs={12} md={6}>
          <StyledPaper elevation={3}>
            <Box
              ...
              sx={{ width: '100%', height: 200, objectFit: 'cover', borderRadius: '4px' }}
            />
            <Typography variant="h6" align="center" gutterBottom>General Consultation</Typography>
            <Typography variant="body1">Our general consultation service is available to address your health concerns and provide you with expert advice.</Typography>
          </StyledPaper>
        </Grid>
        <Grid item xs={12} md={6}>
          <StyledPaper elevation={3}>
            ...
            <Typography variant="body1">We provide 24/7 emergency services to ensure you receive immediate care when you need it the most.</Typography>
          </StyledPaper>
        </Grid>
        <Grid item xs={12} md={6}>
          <StyledPaper elevation={3}>
            ...
            <Typography variant="body1">Our specialists are here to offer advanced medical treatments and personalized care for complex health issues.</Typography>
          </StyledPaper>
        </Grid>
        <Grid item xs={12} md={6}>
          <StyledPaper elevation={3}>
            ...
            <Typography variant="body1">We offer comprehensive inpatient and outpatient care to meet all your healthcare needs.</Typography>
          </StyledPaper>
        </Grid>
      </Grid>
    </StyledBox>
